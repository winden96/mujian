...
export default {
  ...
  theme: {
    extend: {
      colors: {
        'mujian-page': 'var(--mujian-page)',
        'mujian-surface': 'var(--mujian-surface)',
        'mujian-subtle': 'var(--mujian-surface-subtle)',
        'mujian-text': 'var(--mujian-text)',
        'mujian-muted': 'var(--mujian-text-muted)',
        'mujian-line': 'var(--mujian-line)',
        ...
        'semi-color-bg-overlay': 'var(--semi-color-bg-overlay)',
